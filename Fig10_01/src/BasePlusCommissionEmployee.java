...
public class BasePlusCommissionEmployee extends CommissionEmployee {
   ...
   /*this (earnings)is polymorphism, this overrides the earnings method in commissionEmployee.java*/
   ...
   /*This toString is also polymorphism as it overrides the toString in the superclass CommissionEmpolyee.java*/
