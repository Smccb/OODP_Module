import java.awt.*;
import javax.swing.*;
//graphics which draws out the shared instance and external componests of each folder
class Folder extends JComponent{
   ...
   //in charge of drawing out the folders
   public void draw(Graphics g, int tx, int ty, String name)
   {
      ...
      poly.addPoint (tx+tableft,ty);//Appends the specified coordinates to this Polygon.
